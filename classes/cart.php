...
<?php
    ...
    {   
        ...
        public function update_quantity_cart($quantity,$cartId){
            ...
            if($result){
                $msg= "<span class='success'>Product Quantity update sucessfully</span>";
                return $msg;
            }else{
                $msg= "<span class='error'>Product Quantity update not sucessfully</span>";
                return $msg;
            }
        }
        public function del_product_cart($cartid){
            ...
            if($result){
                ...
                $msg= "<span class='error'>Product delete not sucessfully</span>";
                return $msg;
            }
        }
        ...
        public function shifted($id,$time,$price){
            ...
            $result=$this->db->update($query);
            if($result){
                $msg= "<span class='success'>Order update sucessfully</span>";
                return $msg;
            }else{
                $msg= "<span class='error'>Order update not sucessfully</span>";
                return $msg;
            }
        }
        public function del_shifted($id,$time,$price){
            ...
            $result=$this->db->delete($query);
            if($result){
                $msg= "<span class='success'>delete sucessfully</span>";
                return $msg;
            }else{
                $msg= "<span class='error'>delete not sucessfully</span>";
                return $msg;
            }
        }
