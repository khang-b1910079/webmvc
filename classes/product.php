...
<?php
    ...
    {   
        ...
        public function insert_product($data,$file){
            ...
            //kiểm tra hình ảnh và lấy hình ảnh cho vào upload
            $permited = array('jpg','jpeg','png','gif');
            $file_name= $_FILES['image']['name'];
            $unique_size= $_FILES['image']['size'];
           ...
           if($productName==""||$brand==""||$category==""||$product_desc==""||$price==""||$type==""){
                ...
                if(!empty($file_name)){
                    ...
                    if($file_size>20480){
                        ...
                        $alert = "<span class='success'>Image should be less then 2Mb!</span>";
                    return $alert;
                    }
                    ...
                    move_uploaded_file($file_temp,$uploaded_image);
                    $query = "UPDATE tbl_product SET productName = '$productName', brandId = '$brand', catId = '$category', 
                    type = '$type', 
                    price = '$price', 
                    image = '$unique_image', 
        ...
        public function getLastestHuawai(){
        ...
        public function insertCompare($productid,$customer_id){
            ...
            if($result_check_compare){
                $msg="<span class='error'>Compare Already added";
                return $msg;
            }else{
    ...
    public function insertWishlist($productid,$customer_id){
            ...
            if($result_check_wlist){
                $msg="<span class='error'>Wishlist Already added";
                return $msg;
            }else{
            $query="SELECT *from tbl_product where productId='$productid'";
            $result =$this->db->select($query)->fetch_assoc();
